...
public class MainScreen21 extends JFrame implements WindowListener,ActionListener
{
	JButton Browse,Reassemble,About,Exit,Select,Help,Split;
	...
	MainScreen21()
	{
		...
		Reassemble=new JButton("Reassemble");
		...
		Reassemble.addActionListener(this);
	...
	{	
		...
		Reassemble.setLocation(400,100);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		as1.AssembleFile(sourceFile,destFile,size,no_of_parts);
		}
                      	catch(Exception e2)
		{
